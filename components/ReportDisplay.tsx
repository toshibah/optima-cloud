...
export const ReportDisplay: React.FC<ReportDisplayProps> = ({ reportContent, onReset, onRerun }) => {
    ...
    <div className="fade-in">
      <div className="no-print flex flex-col sm:flex-row justify-between items-stretch sm:items-center mb-6 gap-4">
        ...
        <form onSubmit={handleEmailSubmit} className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          ...
          <button type="submit" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
